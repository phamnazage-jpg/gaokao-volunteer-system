...
- `docs/PRIVACY_POLICY_DRAFT.md` 已升级为正式版本（经法务审核），补齐：
  ...
  - 运营主体：龙某某（个人开发者）
  - 联系邮箱：lon22@qq.com
  - 版本号：privacy-policy-v2026.06.25 / 生效日期：2026-06-25
- `docs/SERVICE_TERMS.md` 已同步升级为正式版本（经法务审核），补齐：
  ...
  - 运营主体：龙某某（个人开发者）
  - 联系邮箱：lon22@qq.com
  - 版本号：service-terms-v2026.06.25 / 生效日期：2026-06-25
- **法务审核已完成，正式版已生效**
...
- ~~对外正式法务审阅与版本管理（PM/legal 拍板）~~ → **已完成（v2026.06.25 已审核）**
