...
最后更新: 2026-06-25
状态词: 本地验证完成（v2.1 主链与 6/20/6/21 增量仍成立；crowd_db 27省口径已全部达到 usable 及以上，当前 live 基线为 12 high / 15 usable / 0 skeleton；31 省真正全国口径仍缺 4 个自治区；crowd_db 质量门槛已硬化为综合判定，防静默升级）
