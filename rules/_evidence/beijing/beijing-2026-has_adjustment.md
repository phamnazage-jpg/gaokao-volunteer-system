# beijing-2026-has_adjustment

> 对应规则: `BEIJING.has_adjustment`
> 所属: 省级
> 规则版本: `2026.1`
> 摘录时间: 2026-06-18
...
```yaml
BEIJING.has_adjustment:
  severity: warning
  value:
    has_adjustment: true
  effective_date: '2026-01-01'
  source_evidence_id: beijing-2026-has_adjustment
  status: active
```

## 3. 关键边界与例外

- 例 1：北京考试报官方解读明确存在“是否服从…调剂”选项，因此 `has_adjustment=true`
- 例 2：2026 年样表把该选项落到实际填报表单，证明该调剂开关在当前招生季仍保留
