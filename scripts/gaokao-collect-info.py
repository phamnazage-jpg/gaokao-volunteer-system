        ...
        while True:
            try:
                ...
                if mode == 1:
                    ...
                    self.data["exam_info"]["main_subject"] = input(
                        "   首选科目（物理/历史）："
                    ).strip()
                else:
                    raise ValueError
...
╚══════════════════════════════════════════════════════════════════╝
        ...
        self.data["interest_profile"]["holland_code"] = (
...
╚══════════════════════════════════════════════════════════════════╝
        ...
        if city_choice == "6":
            ...
            city = (
                cities[int(city_choice) - 1]
                if city_choice.isdigit() and 1 <= int(city_choice) <= 6
                else "不限定"
            )
...
╚══════════════════════════════════════════════════════════════════╝
    ...
    def save_data(self, filename=None):
        ...
        self.data["meta"] = {"created_at": datetime.now().isoformat(), "version": "2.0"}
...
if __name__ == "__main__":
    ...
    if data_file:
        print(f"\n数据文件：{data_file}")
        print("\n提示：您可以使用以下命令生成可视化报告：")
        print("  python3 ~/.local/bin/gaokao-visual-report-v2.py")
